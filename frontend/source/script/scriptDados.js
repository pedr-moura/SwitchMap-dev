        ...
        dados.hosts.forEach(ponto => {
            if (ponto.local) {
                ...
                const iconeCustomizado = L.divIcon({
                    ...
                    html: `<img src="https://i.ibb.co/21HsN0y1/sw.png" id="icone-sw" style="border: 2px solid ${ponto.ativo}; ${zindex} box-shadow: inset 0 0 0 1.5px blue; cursor: grab;" onclick="map.flyTo([${lat}, ${lng}], 17, { duration: 0.5 }).setMaxZoom(17)"/>`,
                    iconSize: [0, 0],
                    iconAnchor: [16, 30],
                    popupAnchor: [0, -30]
                });
